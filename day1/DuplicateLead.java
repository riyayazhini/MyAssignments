...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		WebElement cpn = driver.findElement(By.id("createLeadForm_companyName"));
		cpn.sendKeys("Tesstleaf");
        ...
        WebElement cpn1 = driver.findElement(By.id("createLeadForm_companyName"));
		cpn1.clear();
		cpn1.sendKeys("Leaftap");
		WebElement fn1 = driver.findElement(By.id("createLeadForm_firstName"));
		fn1.clear();
		fn1.sendKeys("Miruthi");
		driver.findElement(By.linkText("Create Lead")).click();
		driver.getTitle();
